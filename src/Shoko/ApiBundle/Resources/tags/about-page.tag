<bubbles-about>
  ...
  <p>{ Translator.trans('about.thanks.iThank') }
    <ul class="list-unstyled">
      ...
      <li><strong><a href="//marvel.com">Marvel</a></strong> { Translator.trans('about.thanks.marvel') }</li>
      <li><strong><a href="//github.com/redpanda">Redpanda</a></strong> { Translator.trans('about.thanks.redpanda') }</li>
